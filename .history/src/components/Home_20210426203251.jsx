  ...
  <section>
    ...
    <div>
      ...
      <ul className="feature-list">
        ...
        <li>Implementing pixel-perfect responsive front-ends from Sketch, Photoshop, or Figma designs</li>
        ...
        <li>Implementing and contributing to component design systems</li>
        ...
        <li>Recovery and remediation of struggling projects</li>
